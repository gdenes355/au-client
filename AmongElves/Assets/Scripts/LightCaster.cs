...
/** based on https://www.infogamerhub.com/ */
    ...
    void Update()
    {
        ...
        for (int i = 0; i < sceneObjects.Length; i++)
        {
            ...
            for (int j = 0; j < mesh.Length; j++)
            {
                ...
                Physics.Raycast(myLoc, new Vector2(vertLoc.x - myLoc.x - offset, vertLoc.y - myLoc.y - offset), out hit, 100, ~ignoreMe);
                Physics.Raycast(myLoc, new Vector2(vertLoc.x - myLoc.x + offset, vertLoc.y - myLoc.y + offset), out hit2, 100, ~ignoreMe);
